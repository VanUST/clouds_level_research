...
\begin{frame}{Полный конвейер обработки}
\begin{center}
\renewcommand{\arraystretch}{1.6}
\begin{tabular}{c c c c c}
\fbox{Стереопара} & $\rightarrow$ & \fbox{\shortstack{Аффинная\\калибровка}} & $\rightarrow$ & \fbox{\shortstack{LoFTR\\мэтчинг}} \\[2mm]
& & & & $\downarrow$ \\[2mm]
\fbox{Оценка НГО} & $\leftarrow$ & \fbox{\shortstack{Фильтр\\Калмана}} & $\leftarrow$ & \fbox{\shortstack{HDBSCAN\\кластеризация}} \\[2mm]
& & $\updownarrow$ & & \\[2mm]
\multicolumn{3}{c}{\fbox{Пространственный фильтр}} & & \\
\end{tabular}
\end{center}
\end{frame}
